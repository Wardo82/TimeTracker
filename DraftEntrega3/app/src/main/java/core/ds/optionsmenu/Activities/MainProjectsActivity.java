...
import core.ds.optionsmenu.Model.MyDrawerLayout;
...
public class MainProjectsActivity extends AppCompatActivity
    ...
    private class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (intent.getAction().equals(CTimeTrackerEngine2.HAS_CHILDREN)) {
                ...
                //        m_projectList, MainProjectsActivity.this);
    ...
    public void onCreate(final @Nullable Bundle savedInstanceState) {
        ...
        sendBroadcast(new Intent(MainProjectsActivity.GIVE_CHILDREN));
        ...
        m_toolbar.setTitle("TimeTracker");
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        switch (id){
            case R.id.addOption:
                intent = new Intent(MainProjectsActivity.this,
                    AddActivity.class);
                startActivity(intent);
                Toast.makeText(MainProjectsActivity.this,
            ...
            case R.id.deleteOption:
                intent = new Intent(MainProjectsActivity.ERASE_ELEMENT);
    ...
    public final void onBackPressed() {
        ...
        sendBroadcast(new Intent(MainProjectsActivity.STOP_SERVICE));
        super.onBackPressed();
        finish();
    }
    /**
