...
public class TaskActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        trackButton.setBackgroundResource(R.drawable.radio_button_outline);
        trackButton.setId(R.id.button);
        trackButton.setTag("Track button");
        trackButton.setLayoutParams(params);
        String text = m_task.isTracked() ? "Pause" : "Play";
        trackButton.setText(text);
        trackButton.setTextColor(getResources().getColor(R.color.white));
    ...
    private class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (intent.getAction().equals(CTimeTrackerEngine2.HAS_CHILDREN)) {
                ...
                int mode = m_task.isTracked() ? View.VISIBLE : View.INVISIBLE;
                isTrackingButton.setVisibility(mode);
